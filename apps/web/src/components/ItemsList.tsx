      ...
      <div className="bg-card border border-border rounded-xl p-3.5 sm:p-5 shadow-lg space-y-3.5 transition-colors">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-border">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2
                  className="font-extrabold text-sm sm:text-base text-foreground tracking-tight"
          ...
          <div className="flex items-center gap-2">
            ...
            <SimpleTooltip
              content="Add item from Wikipedia search, URL, or custom text (N)"
              shortcut="N"
              side="top"
            >
              <Button
          ...
          {poolItemIds.length === 0 ? (
            <div className="w-full py-8 flex flex-col items-center justify-center text-center space-y-1.5">
              ...
              <p className="text-xs text-muted-foreground max-w-sm">
                Every tile has been assigned a grade. You can export your list or add
                custom cards.
              </p>
              <Button
                variant="outline"
            ...
            filteredPoolItems.map((item) => (
              <DraggableItem key={item.id} item={item} currentContainerId="POOL" />
            ))
          )}
        </div>
      </div>
