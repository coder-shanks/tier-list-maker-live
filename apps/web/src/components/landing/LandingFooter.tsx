...
export default function LandingFooter() {
  ...
  return (
    <footer
      id="shortcuts"
      className="relative pt-16 sm:pt-24 pb-12 overflow-hidden bg-card dark:bg-zinc-950 border-t border-border dark:border-white/10"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative rounded-3xl p-8 sm:p-14 bg-gradient-to-b from-card via-card to-secondary/50 dark:from-zinc-900/90 dark:to-zinc-950/90 border border-border dark:border-white/15 backdrop-blur-2xl shadow-xl dark:shadow-2xl text-center overflow-hidden mb-16 sm:mb-20">
          {/* Ambient Glow */}
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <p className="text-base sm:text-lg text-muted-foreground mb-8 max-w-xl mx-auto">
              Start building your tier list right now. No email required, zero ads, and
        ...
        <div className="py-6 px-6 rounded-2xl bg-secondary/80 dark:bg-zinc-900/50 border border-border dark:border-white/10 mb-12 flex flex-col md:flex-row items-center justify-between gap-4 text-xs font-mono text-muted-foreground shadow-xs">
          ...
          <div className="flex flex-wrap items-center gap-3">
            {footerShortcuts.map((sc) => (
              <div key={sc.key} className="flex items-center gap-1.5">
                <kbd className="px-2 py-0.5 rounded bg-card dark:bg-zinc-800 text-foreground dark:text-zinc-200 border border-border dark:border-white/10 text-[11px] font-bold shadow-2xs">
                  {sc.key}
                </kbd>
                <span className="text-muted-foreground text-[11px]">{sc.name}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-border dark:border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono text-muted-foreground">
          <div className="flex items-center gap-2.5">
            <img src="/logo.png" alt="Logo" className="w-5 h-5 rounded" />
            <span className="text-foreground font-bold">Live Tier List Maker</span>
            <span>•</span>
