...
const KEYBOARD_SHORTCUTS = [
  {
    key: '⌘ + Z',
    name: 'Instant Undo',
    desc: 'Undo any placement mistake in one click.',
  },
  { key: '⌘ + E', name: 'Quick Export', desc: 'Open crystal-clear image export dialog.' },
  {
    key: 'R',
    name: 'Spin Roulette',
    desc: 'Pick a random unranked item live on stream.',
  },
  {
    key: 'B',
    name: 'Blind Challenge',
    desc: 'Play blind ranking without knowing what comes next.',
  },
  {
    key: 'P',
    name: 'Clean Stream View',
    desc: 'Hide all buttons for clean OBS screen shares.',
  },
...
export default function StreamerShowcaseSection() {
  ...
  const [blindSlots, setBlindSlots] = useState<
    Record<number, (typeof BLIND_DECK)[0] | null>
  >({
    1: null,
    2: null,
    3: null,
  ...
  return (
    <section
      id="streamer"
      className="relative py-20 sm:py-28 overflow-hidden bg-secondary/30 dark:bg-zinc-950/60 border-t border-b border-border dark:border-white/10"
    >
      {/* Radial accent glow */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
          ...
          <p className="text-base sm:text-lg text-muted-foreground">
            Interactive widgets made for Twitch, YouTube, Kick, and Discord streams. Zero
            clutter, exciting viewer games, and instant shortcuts.
          </p>
        </div>
              ...
              <div className="space-y-6 animate-in fade-in duration-200">
                ...
                <div className="pt-3 border-t border-border dark:border-white/10 flex flex-col sm:flex-row items-center gap-3">
                  ...
                  >
                    ...
                    />
                    <span>
                      {isSpinning ? 'Picking Random Item...' : '🎲 Spin Live Roulette'}
                    </span>
                  </button>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed mb-3">
                    Instantly hide all sidebars and buttons so your live stream or screen
                    share looks clean and professional.
                  </p>
