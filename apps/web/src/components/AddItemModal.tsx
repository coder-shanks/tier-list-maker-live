          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <DialogDescription className="text-xs">
                Search open-source web photos, upload local images, or bulk import item
                names.
              </DialogDescription>
            </div>
          </div>
            ...
            <TabsContent value="search" className="pt-3 space-y-3">
              <form onSubmit={handlePerformSearch} className="flex gap-2">
                ...
                <Button
                  ...
                  className="gap-1.5 font-bold h-8 text-xs bg-foreground text-background"
                >
                  {isSearching ? (
                ...
                {isSearching ? (
                  ...
                  <div className="py-12 text-center text-xs text-muted-foreground font-mono">
                    {hasSearched
                      ...
                      : 'Search open-source web photos above.'}
                  </div>
                ) : (
                      ...
                      {imageUrl && !previewError ? (
                        ...
                        <div className="w-full h-full bg-zinc-900 flex flex-col items-center justify-center text-zinc-100 font-mono font-bold text-xs p-1">
                          <span className="text-sm">
                            {title.slice(0, 3).toUpperCase() || 'NEW'}
                          </span>
                        </div>
                      )}
