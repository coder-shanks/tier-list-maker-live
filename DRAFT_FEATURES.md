...
* **Transport / Synchronization Layer**:
  * *Option A (Lightweight)*: Firebase Realtime Database / Supabase Realtime for instant room sync without backend server maintenance.
  * *Option B (P2P / PeerJS)*: WebRTC connection using PeerJS where the streamer acts as host node.
* **Components to Build**:
