          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <DialogDescription className="text-xs text-muted-foreground">
                Mystery items are drawn one-by-one. Lock your rank without knowing what is coming next!
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="p-3 rounded-xl bg-secondary/70 border border-border/80 text-xs space-y-1.5 font-sans">
            ...
            <ul className="space-y-1 text-muted-foreground text-[11px] list-disc list-inside">
              ...
              <li>Once placed into a tier, items are <strong>permanently locked</strong> in stone.</li>
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  <div className="flex items-center gap-1.5 font-bold text-xs text-foreground">
                    <HugeiconsIcon icon={Layers01Icon} size={15} className="text-rose-500" />
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  <div className="flex items-center gap-1.5 font-bold text-xs text-foreground">
                    <HugeiconsIcon icon={FlameIcon} size={15} className="text-amber-500" />
                ...
                <p className="text-[11px] text-muted-foreground leading-relaxed">
                  Strict slot capacity per tier (e.g. Max 1 in S-Tier). Tiers lock once filled!
                </p>
              </button>
            </div>
          </div>
            ...
            <div className="space-y-1.5 text-xs">
              <label className="flex items-center gap-2 cursor-pointer select-none">
                ...
                <span className="font-medium text-foreground">
                  Reset board and shuffle all <strong>{totalItemsCount}</strong> items into draw deck
                </span>
              </label>
              ...
              {poolCount > 0 && poolCount < totalItemsCount && (
                <label className="flex items-center gap-2 cursor-pointer select-none">
                  ...
                  />
                  <span className="font-medium text-foreground">
                    Keep current board and only rank remaining <strong>{poolCount}</strong> vault items
                  </span>
                </label>
              )}
            </div>
