...
export default function LandingPage() {
  ...
  return (
    <div className={`min-h-screen ${pageBgClass} text-foreground flex flex-col font-sans antialiased selection:bg-rose-500/30 selection:text-rose-200 transition-colors duration-200 relative`}>
