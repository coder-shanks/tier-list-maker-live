      ...
      <DialogContent className="sm:max-w-3xl max-h-[85vh] flex flex-col p-0 overflow-hidden bg-card border-border">
        <DialogHeader className="p-4 sm:p-5 border-b border-border">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <DialogTitle className="text-base sm:text-lg font-bold" style={{ fontFamily: 'var(--font-display)' }}>
                Curated Tier List Templates
              </DialogTitle>
              <DialogDescription className="text-xs">
                Select from {TEMPLATES.length} pre-built collections across gaming, cinema, tech, anime, and pop culture.
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
