    ...
    <div className="w-full max-w-7xl mx-auto mt-4 sm:mt-6">
      <div className="bg-card border border-border rounded-xl p-3.5 sm:p-5 shadow-lg space-y-3.5 transition-colors">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3 pb-3 border-b border-border">
          ...
          {/* Action Toolbar with Distinct Challenge Modes & Tools */}
          <div className="flex flex-wrap items-center gap-2 sm:gap-2.5">
            {/* Challenge Modes Group */}
            <div className="flex items-center gap-1.5 p-1 rounded-xl bg-secondary/60 border border-border/80">
              {/* Blind Ranking Challenge Button */}
              <SimpleTooltip
                content={
                  isRandomPickerOpen
                    ? 'Roulette is currently open'
                    : 'Gamified Blind Ranking Challenge Mode (B)'
                }
                shortcut="B"
                side="top"
              >
                <Button
                  ...
                  className="bg-linear-to-r from-rose-600 to-amber-600 hover:from-rose-500 hover:to-amber-500 text-white font-bold gap-1.5 h-8 text-xs shadow-xs active:scale-95 transition-all cursor-pointer border-0 disabled:opacity-40 disabled:cursor-not-allowed"
                >
              ...
              <SimpleTooltip
                content={
                  isBlindActive
                    ? 'Blind challenge is active'
                    : 'Spin random item for stream / audience ranking (R)'
                }
                shortcut="R"
                side="top"
              >
                <Button
                  ...
                  disabled={isBlindActive || poolItemIds.length === 0}
                  className="bg-background border-border font-bold gap-1.5 h-8 text-xs active:scale-95 transition-all cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed hover:bg-accent"
                >
                  <HugeiconsIcon icon={DicesIcon} size={14} className="text-cyan-500" />
                  <span>Roulette</span>
                </Button>
              </SimpleTooltip>
            </div>

            {/* Standard Vault Tools Group */}
            <div className="flex items-center gap-1.5">
              ...
              <SimpleTooltip content="Clear board and return all items back into vault" side="top">
                <Button
                  ...
                  className="bg-secondary border-border text-amber-500 hover:text-amber-600 hover:bg-amber-500/10 gap-1.5 h-8 text-xs active:scale-95 disabled:opacity-40 disabled:cursor-not-allowed"
                >
